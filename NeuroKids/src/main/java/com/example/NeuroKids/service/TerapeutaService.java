...
public class TerapeutaService {
    ...
    // UPDATE
    @Transactional
    public TerapeutaResponseDTO atualizar(
            Long id,
            TerapeutaRequestDTO dto
    ) {
        ...
        terapeuta.setRegistroProfissional(
                dto.getRegistroProfissional()
        );
        terapeuta.setEspecialidade(
    ...
    private void validarEmail(String email) {
        ...
        if (emailExiste) {
            ...
            throw new RuntimeException(
                    "Já existe terapeuta com este email"
            );
        }
    }
    ...
    private void validarEspecialidade(
            TerapeutaRequestDTO dto
    ) {
        ...
        if (
            ...
            throw new RuntimeException(
                    "Descreva a abordagem terapêutica"
            );
        }
    }

    // MAPPER
    private TerapeutaResponseDTO converterParaDTO(
            Terapeuta terapeuta
    ) {
        ...
        return TerapeutaResponseDTO.builder()
                ...
                .registroProfissional(
                        terapeuta.getRegistroProfissional()
                )
                .especialidade(
                        terapeuta.getEspecialidade()
                )
                .abordagemTerapeutica(
                        terapeuta.getAbordagemTerapeutica()
                )
                .ativo(terapeuta.getAtivo())
                .pacientes(
                        terapeuta.getPacientes() != null
                                ? terapeuta.getPacientes()
                                  .stream()
                                  .map(p -> p.getNome())
                                  .toList()
                                : List.of()
